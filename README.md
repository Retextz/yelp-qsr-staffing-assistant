...
Below are sample output visualizations generated by the assistant:

- **Check-in Distribution by Day**: `output/skill_01_checkins_by_day.png`
- **Group Comparison (QSR vs Full Service)**: `output/skill_02_group_comparison.png`
- **Predicted vs Actual Check-ins**: `output/skill_03_model_predictions.png`
- **48-Hour Staffing Forecast Line Plot**: `output/skill_04_staffing_forecast.png`
- **Geospatial Performance Clusters Map**: `output/skill_05_spatial_clusters.png`
